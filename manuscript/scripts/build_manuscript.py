...
"Fig2_performance":"Figure 2. Reversible plating without a transport advantage (bare-APC versus poly-APC). (a,b) Mg||Mo6S8 discharge capacity and Coulombic efficiency per cycle at 0.5C and 1C. (c) poly-APC charge–discharge voltage profiles at selected cycles. (d) Mg||Mg symmetric-cell voltage versus time. (e) Tri-variate benchmark of non-aqueous Mg-metal full cells from the literature in three performance dimensions: cycle number (x axis), Coulombic efficiency (y axis), and C-rate (bubble size; 1C = 128.8 mA/g). Marker fill encodes verification confidence and open symbols are reports not independently confirmed here (sources tabulated in the Supporting Information). poly-APC lies on the Pareto front of all three: it provides the highest Coulombic efficiency among Mg full cells that exceed about 1500 cycles, at a practical 1C rate, between the ultralow rate of the earliest benchmark and the extreme rate of the longest-cycle report.",
