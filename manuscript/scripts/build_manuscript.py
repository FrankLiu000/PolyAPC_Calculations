...
"anion, keeping it from the reductive front. Interfacial molecular dynamics makes this concrete (Figure 6f): in "
"liquid APC the reducible aluminate occupies the near-electrode zone, within about 0.5 nm of the front, almost "
"continuously and sits closer to the metal than the magnesium cation, whereas in the gel that near-front "
"occupancy falls by more than an order of magnitude and the interfacial ordering inverts, so the innocuous "
"magnesium cation leads and the reducible anion is held behind it. The network thus realizes structurally, and "
"without stirring, the homogenization of the interfacial anion concentration whose absence drives uneven "
"stripping in the liquid.{liu2022strip} The absolute standoff in the gel is a soft, slowly relaxing coordinate "
"that we report as a bound rather than a single value, but the exclusion and the inversion are robust across "
"independent runs. Electronically, the silicon-rich "
...
"Fig2_performance":"Figure 2. Reversible plating without a transport advantage (bare-APC versus poly-APC). (a,b) Mg||Mo6S8 discharge capacity and Coulombic efficiency per cycle at 0.5C and 1C. (c) poly-APC charge–discharge voltage profiles at selected cycles. (d) Mg||Mg symmetric-cell voltage versus time. (e) Three-dimensional benchmark of non-aqueous Mg-metal full cells from the literature, plotting cycle number, C-rate (1C = 128.8 mA/g), and Coulombic efficiency as the three axes of a performance cube. Marker fill encodes verification confidence and open symbols are reports not independently confirmed here (sources tabulated in the Supporting Information). poly-APC occupies the favorable corner and lies on the three-dimensional Pareto front: the highest Coulombic efficiency among Mg full cells that exceed about 1500 cycles, at a practical 1C rate, between the ultralow rate of the earliest benchmark and the extreme rate of the longest-cycle report.",
