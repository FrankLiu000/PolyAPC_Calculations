...
| `pairing_pmf.txt` | **NEW** — genuine 2D pairing free-energy landscape (classical MD, 3×100 ns × 80 pairs each): bare/poly **nearly identical** (CIP 98.3 vs 96.7%, ΔF_diss 2.43 vs 2.08 kcal/mol) → abstraction contrast is NOT pre-encoded in pairing ΔF | high (FF level; no bond-breaking) |
